...
WorldPacket const* WorldPackets::LFG::PvpRewardsResponse::Write()
{
    ...
    _worldPacket << Rewards[(uint8)BattlegroundBracketType::Unk0];
    _worldPacket << Rewards[(uint8)BattlegroundBracketType::Unk1];
