		...
		while (uint32 eventId = _events.ExecuteEvent())
		{
            ...
            case EVENT_ARONUS_SUMMON_RAGNAROS:
                if (Creature* deathwing = me->FindNearestCreature(NPC_DEATHWING, 200.0f, true))
                {
                    ...
                    // deathwing->CastSpell(4039.558, -3061.701, 972.6672, SPELL_SUMMON_RAGNAROS, true);
                }

                if (Creature* ragnaros = me->SummonCreature(38806, 4039.558f, -3061.701f, 972.6672f, 0.1047198f))
                {
                    ragnaros->HandleEmoteCommand(449);
                    ragnaros->AI()->Talk(0);
                    ragnaros->ForcedDespawn(10000);
                }
