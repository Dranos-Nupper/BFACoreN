        ...
        struct npc_tortos_whirl_turtleAI : public ScriptedAI
        {
            ...
            void DoAction(const int32 action)
            {
                if (action == ACTION_TURTLE_KICKED)
                {
                    ...
                    {
                        if (Creature* pTortos = pInstance->instance->GetCreature(pInstance->GetObjectGuid(DATA_TORTOS)))
                        {
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                switch (events.ExecuteEvent())
                {
                    ...
                    {
                        std::list<Player*> plrList = me->SelectNearestPlayers(5, true);
    ...
    public:
        ...
        class spell_tortos_shell_concussion_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                ...
                BeforeHit += BeforeSpellHitFn(spell_tortos_shell_concussion_SpellScript::HandleBeforeHit);
            }
        };
    ...
    public:
        ...
        class spell_tortos_crystal_shell_heal_absorption_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                ...
                OnEffectAbsorb += AuraEffectAbsorbFn(spell_tortos_crystal_shell_heal_absorption_AuraScript::OnAbsorb, EFFECT_0);
            }
        };
