    ...
    public:
        ...
        struct boss_durumu_the_forgottenAI : public BossAI
        {
            boss_durumu_the_forgottenAI(Creature* p_Creature) : BossAI(p_Creature, DATA_DURUMU_THE_FORGOTTEN), mazeBuilder(me)
            {
                ...
                introDone = false;
                crimsonFogsCount = 0;
                eyebeamTargetGUID = ObjectGuid::Empty;
            }
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_FORCE_OF_WILL:
                        {
                            ...
                            if (target)
                            {
                                if (Creature* pEye = me->SummonCreature(NPC_MIND_S_EYE, *me, TEMPSUMMON_TIMED_DESPAWN, 7000))
                                {
                                    ...
                                    pEye->SetFloatValue(0, forceWillOrientation);
                        ...
                        case EVENT_SECOND_PHASE_BEGIN:
                        {
                            ...
                            for (std::set<ObjectGuid>::const_iterator itr = coloredEyes.begin(); itr != coloredEyes.end(); ++itr)
                            {
                                if (Creature* pEye = ObjectAccessor::GetCreature(*me, (*itr)))
                                {
        ...
        private:
            ...
            std::set<ObjectGuid> coloredEyes;
        ...
        private:
            ...
            void FillBeamPath(Movement::PointsArray& path)
            {
                ...
                {
                    G3D::Vector3 vector = {beamPos[i].GetPositionX(), beamPos[i].GetPositionY(), beamPos[i].GetPositionZ()};
    ...
    public:
        ...
        private:
            ...
            void SendDied()
            {
                ...
                Creature* pDurumu = pInstance->instance->GetCreature(pInstance->GetObjectGuid(DATA_DURUMU_THE_FORGOTTEN));
                if (!pDurumu)
                    return;
                            ...
                            switch (me->GetEntry())
                            {
                                ...
                                case NPC_RED_EYE:
                                {
                                    ...
                                    for (std::list<Creature*>::const_iterator itr = creatures.begin(); itr != creatures.end(); ++itr)
                                    {
                                        ...
                                        if (me->isInFront(pCrimsonFog, 3.14159f / 7))
                                        {
    ...
    public:
        ...
        class spell_durumu_the_forgotten_life_drain_dmg_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                Unit* target = ObjectAccessor::GetUnit(*pEye, pEye->AI()->GetGUID());
                if (!target)
                    return;
            ...
            void HandleOnHit(SpellEffIndex effIndex)
            {
                ...
                GetCaster()->CastCustomSpell(GetCaster(), SPELL_LIFE_DRAIN_HEAL, &damage, NULL, NULL, true);
            }
    ...
    public:
        ...
        class spell_durumu_the_forgotten_force_of_will_dmg_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                {
                    GetCaster()->SetOrientation(pEye->GetFloatValue(0));

                    for (std::list<WorldObject*>::iterator itr = targets.begin(); itr != targets.end();)
                    {
                        if (!GetCaster()->isInFront((*itr), 3.14159f / 8))
                        {
    ...
    public:
        ...
        class spell_durumu_the_forgotten_bright_light_dmg_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                for (std::list<Player*>::iterator itr = players.begin(); itr != players.end(); ++itr)
                {
                    if (GetCaster()->isInFront((*itr), 3.14159f / 7))
                    {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_durumu_the_forgotten_bright_light_dmg_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_CONE_ENTRY_110);
            }
        };
...
class spell_durumu_the_forgotten_infrared_light_dmg: public SpellScriptLoader
{
    public:
        ...
        class spell_durumu_the_forgotten_infrared_light_dmg_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_durumu_the_forgotten_infrared_light_dmg_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_CONE_ENTRY_110);
            }
        };
...
class spell_durumu_the_forgotten_blue_rays_dmg: public SpellScriptLoader
{
    public:
        ...
        class spell_durumu_the_forgotten_blue_rays_dmg_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_durumu_the_forgotten_blue_rays_dmg_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_CONE_ENTRY_110);
            }
        };
