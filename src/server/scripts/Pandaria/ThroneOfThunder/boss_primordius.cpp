    ...
    public:
        ...
        struct boss_primordiusAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                {
                    if (GameObject* l_Vat = instance->instance->GetGameObject(instance->GetObjectGuid(gobEntries[l_Index])))
    ...
    public:
        ...
        private:
            ...
            Creature* GetPrimordius()
            {
                ...
                {
                    return pInstance->instance->GetCreature(pInstance->GetObjectGuid(DATA_PRIMORDIUS));
                }
...
class spell_primordius_congeal_blood: public SpellScriptLoader
{
    public:
        ...
        class spell_primordius_congeal_blood_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                BeforeHit += BeforeSpellHitFn(spell_primordius_congeal_blood_SpellScript::HandleBeforeHit);
            }
        };
