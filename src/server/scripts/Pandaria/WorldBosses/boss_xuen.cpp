...
{
    boss_xuen(Creature* pCreature) : ScriptedAI(pCreature) {}
...
public:
    ...
    class spell_celestial_challenge_xuen_crackling_lightning_SpellScript : public SpellScript
    {
        ...
        void HandleHitTarget(SpellEffIndex effIndex)
        {
            ...
            GetCaster()->CastSpell(GetHitUnit(), SPELL_CRACK_LIGHTNING_D, true);
        }
...
public:
    ...
    class spell_celestial_challenge_xuen_chi_barrage_SpellScript : public SpellScript
    {
        ...
        void HandleHitTarget(SpellEffIndex effIndex)
        {
            ...
            GetCaster()->CastSpell(GetHitUnit(), SPELL_CHI_BARRAGE_M, true);
        }
