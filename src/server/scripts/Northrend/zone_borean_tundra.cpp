...
struct npc_nerub_sinkhole : ScriptedAI
{
    npc_nerub_sinkhole(Creature* creature) : ScriptedAI(creature){}

    enum SpellNerubSinkhole {
        SPELL_EXPLOSION_SINKHOLE = 45502,
    };

    void SpellHit(Unit* caster, const SpellInfo* spell) override
    {
        if (spell->Id == SpellNerubSinkhole::SPELL_EXPLOSION_SINKHOLE)
        {
...
void AddSC_borean_tundra()
{
    ...
    RegisterCreatureAI(npc_nerub_sinkhole);
}
